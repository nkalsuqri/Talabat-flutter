...
class Reorders extends StatefulWidget {
  @override
  _ReordersState createState() => _ReordersState();
}

class _ReordersState extends State<Reorders> {
  @override
  ...
  sss() {
    return SliverToBoxAdapter(
        child: Container(
            ...
            height: 340,
            child: Container(
                width: 200, height: 200, child: Text('-----------------   '))));
  }
}
